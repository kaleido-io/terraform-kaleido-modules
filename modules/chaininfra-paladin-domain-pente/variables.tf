...
variable "txnmanager_service_id" {
  type        = string
  default     = null
  description = "ID of the TransactionManagerService that submits the factory deploy transaction(s) to the base ledger. Required when mode = deploy."
  validation {
...
variable "resource_prefix" {
  type        = string
  default     = ""
  description = "Prefix for ContractManagerService builds and deploys."
}
